...
import s from "features/components/Header/Header.module.css";
...
export default function AccountMenu(props: BasicMenuType) {
    ...
    return (
        <React.Fragment>
            <Box sx={{display: 'flex', alignItems: 'center', textAlign: 'right'}}>
                <Typography sx={{minWidth: 100}}>{props.userName}</Typography>
                <Tooltip title="Menu">
                    <IconButton
                        onClick={handleClick}
                        size="small"
                    ...
                    >
                        <Avatar alt="Konstantine" src={profileImg}/>
                    </IconButton>
                </Tooltip>
            </Box>
            <Menu
